  ...
  return (
    <>
      ...
      <input
        ...
        className={clsx(
          'mt-6 h-9 w-full rounded-lg bg-transparent p-6 pl-4 tracking-wider caret-custom-500 placeholder:text-transparent focus:outline-hidden focus:placeholder:text-bg-500',
          className
        )}
        disabled={disabled}
        inputMode={inputMode}
